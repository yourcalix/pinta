...
const ERROR_MESSAGES = Object.freeze({
  ...
  DRIVER_ACCEPTANCE_CLOSED: '司机承接功能尚未开放',
  DRIVER_NOT_APPROVED: '司机资格尚未通过审核',
  VEHICLE_NOT_APPROVED: '车辆资格尚未通过审核',
  DRIVER_APPLICATION_UNAVAILABLE: '司机认证暂不可提交，请稍后重试',
  DRIVER_CONSENT_REQUIRED: '请先阅读并同意司机认证资料使用说明',
  DRIVER_DOCUMENT_REQUIRED: '请补齐司机认证所需资料',
  DRIVER_APPLICATION_PENDING: '司机认证正在审核中，请勿重复提交',
